...
class ROCKETMQCLIENT_API SessionCredentials {
 public:
  ...
  void set_access_key(const std::string& accessKey) { access_key_ = accessKey; }

  const std::string& secret_key() const { return secret_key_; }
  void set_secret_key(const std::string& secretKey) { secret_key_ = secretKey; }

  const std::string& signature() const { return signature_; }
  void set_signature(const std::string& signature) { signature_ = signature; }

  const std::string& signature_method() const { return signature_method_; }
  void set_signature_method(const std::string& signatureMethod) { signature_method_ = signatureMethod; }

  const std::string& auth_channel() const { return auth_channel_; }
  void set_auth_channel(const std::string& channel) { auth_channel_ = channel; }
