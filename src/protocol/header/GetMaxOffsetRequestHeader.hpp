 ...
 */
#ifndef ROCKETMQ_PROTOCOL_HEADER_GETMAXOFFSETREQUESTHEADER_HPP_
#define ROCKETMQ_PROTOCOL_HEADER_GETMAXOFFSETREQUESTHEADER_HPP_
...
struct GetMaxOffsetRequestHeader : public CommandCustomHeader {
  ...
  GetMaxOffsetRequestHeader() = default;

  GetMaxOffsetRequestHeader(std::string topic, int32_t queue_id) : topic(std::move(topic)), queue_id(queue_id) {}
...
#endif  // ROCKETMQ_PROTOCOL_HEADER_GETMAXOFFSETREQUESTHEADER_HPP_
