 ...
 */
#ifndef ROCKETMQ_PROTOCOL_HEADER_QUERYCONSUMEROFFSETRESPONSEHEADER_HPP_
#define ROCKETMQ_PROTOCOL_HEADER_QUERYCONSUMEROFFSETRESPONSEHEADER_HPP_
...
struct QueryConsumerOffsetResponseHeader : public CommandCustomHeader {
  ...
  static std::unique_ptr<QueryConsumerOffsetResponseHeader> Decode(std::map<std::string, std::string>& extend_fields) {
...
#endif  // ROCKETMQ_PROTOCOL_HEADER_QUERYCONSUMEROFFSETRESPONSEHEADER_HPP_
