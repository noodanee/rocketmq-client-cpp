 ...
 */
#ifndef ROCKETMQ_PROTOCOL_HEADER_GETMINOFFSETRESPONSEHEADER_HPP_
#define ROCKETMQ_PROTOCOL_HEADER_GETMINOFFSETRESPONSEHEADER_HPP_
...
struct GetMinOffsetResponseHeader : public CommandCustomHeader {
  ...
  static std::unique_ptr<GetMinOffsetResponseHeader> Decode(std::map<std::string, std::string>& extend_fields) {
...
#endif  // ROCKETMQ_PROTOCOL_HEADER_GETMINOFFSETRESPONSEHEADER_HPP_
