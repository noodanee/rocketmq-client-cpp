 ...
 */
#ifndef ROCKETMQ_PROTOCOL_HEADER_GETMAXOFFSETRESPONSEHEADER_HPP_
#define ROCKETMQ_PROTOCOL_HEADER_GETMAXOFFSETRESPONSEHEADER_HPP_
...
struct GetMaxOffsetResponseHeader : public CommandCustomHeader {
  ...
  static std::unique_ptr<GetMaxOffsetResponseHeader> Decode(std::map<std::string, std::string>& extend_fields) {
...
#endif  // ROCKETMQ_PROTOCOL_HEADER_GETMAXOFFSETRESPONSEHEADER_HPP_
