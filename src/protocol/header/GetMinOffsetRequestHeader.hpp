 ...
 */
#ifndef ROCKETMQ_PROTOCOL_HEADER_GETMINOFFSETREQUESTHEADER_HPP_
#define ROCKETMQ_PROTOCOL_HEADER_GETMINOFFSETREQUESTHEADER_HPP_
...
struct GetMinOffsetRequestHeader : public CommandCustomHeader {
  ...
  GetMinOffsetRequestHeader(std::string topic, int32_t queue_id) : topic(std::move(topic)), queue_id(queue_id) {}
...
#endif  // ROCKETMQ_PROTOCOL_HEADER_GETMINOFFSETREQUESTHEADER_HPP_
